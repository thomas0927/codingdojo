...
public class FizzBuzzGameTest {
    ...
    @Test(dataProvider = "fizzbuzz_100")
    public void print_fizzbuzz_list(List<String> expected){
        FizzBuzzGame game=new FizzBuzzGame(100);
        Assert.assertEquals(game.play(),expected);
    }

    @DataProvider
    public static Object[] fizzbuzz_100(){
